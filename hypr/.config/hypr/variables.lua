...
return {
	...
	-- Workspaces
	kbOverview = { "SUPER + Return", "SUPER + TAB" },
	kbMoveWinToWsSpecial = { "ALT + SUPER + S", "CTRL + SUPER + SHIFT + Up" },
	kbMoveWiFromWsSpecial = "ALT + SHIFT + D",
	...
	kbNextWs = { "SUPER + mouse_down", "CTRL + SUPER + Right", "SUPER + Page_Down", "SUPER + ALT + N" },
	kbPrevWs = { "SUPER + mouse_up", "CTRL + SUPER + Left", "SUPER + Page_Up", "SUPER + ALT + P" },
